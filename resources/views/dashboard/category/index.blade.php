...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    <a href="/Dashboard/posts/create" class="btn btn-primary">Add New Category</a>
  </div>
</div>
  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>{{ $category->name }}</td>
          <td>
              <a href="/Dashboard/posts/{{ $category->slug }}" class="btn btn-info">Detail</a>
              <a href="/Dashboard/posts/{{ $category->slug }}/edit" class="btn btn-warning">Edit</a>
